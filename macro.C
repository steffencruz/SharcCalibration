...
TH1D *hist = 0;
Double_t pars[] = {50,2700,100};
Double_t parmsMSG[] = {0.0,0.0,30,1500,100,100};
Double_t parmsSG[] = {30,1500,100,100};

void macro(){

  gSystem->Load("libSpectrum.so");
  gSystem->Load("libs/libFitManager.so");
  gSystem->Load("libs/libFitInfo.so");
